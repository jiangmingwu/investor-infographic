...
DATA = {
    ...
    "COMPANY_PROFILE": {
        ...
        "最新股价 / 市值": "约 $429 / $3.19 万亿美元 (2026-04-29)",
        "最新 PE (TTM)": "约 31×",
    },

    "FINANCIAL_SUMMARY": {
        "FY2025 全年营收": "$2,817 亿 (+15% YoY)",
        "FY2025 净利润": "$1,018 亿 (+16% YoY)",
        "FY2025 营业利润率": "约 45%",
        "Q4 FY25 营收": "$764 亿 (+18% YoY)",
        "Azure 全年增速": "约 +34% (AI 需求驱动)",
    ...
    "RISKS_HIGHLIGHTS": [
        ...
        ("风险", "估值 PE 31×", "已反映 AI 溢价,任何 Azure 增速放缓都会被市场严重惩罚"),
    ],
    ...
    "DATA_SOURCE": '经营数据：Microsoft FY2025 Form 10-K / Q4 FY2025 业绩公告（2025-07-30） · 行情数据：CompaniesMarketCap 全球市值排名页，页面查看 2026-04-29（市值/股价为页面展示口径）',
    "FOOTER_LINES": [
        '经营数据：Microsoft FY2025 Form 10-K / Q4 FY2025 业绩公告（2025-07-30）',
