...
ASML_ORANGE = "#FF6A13"
ASML_BLUE = "#0066CC"
FX_NOTE = "欧元金额按 2026-04-26 近似汇率 1 EUR≈1.08 USD 折算"
...
DATA = {
    ...
    "COMPANY_PROFILE": {
        ...
        "员工": "约 4.4 万人",
        "总部": "荷兰 Veldhoven",
        "最新股价 / 市值": "约 $1,385 / $5,336 亿美元 (2026-04-29)",
        "最新 PE (TTM)": "约 58×",
        "光刻机全球市占": "约 90% (EUV 100% 独占)",
    },

    "FINANCIAL_SUMMARY": {
        "FY2025 全年营收": "约 $346 亿美元 (+20% YoY)",
        "FY2025 毛利率": "约 52% (EUV 拉动)",
        "FY2025 净利润": "约 $92 亿美元 (+25% YoY)",
        "FY2025 自由现金流": "约 $108 亿美元",
        "FY2025 订单积压": "约 $389 亿美元 (1 年以上)",
        "FY2025 分红": "约 $32 亿美元",
        "FY2025 回购": "约 $54 亿美元",
        "FY25 CapEx": "约 $22 亿美元 (研发+产能)",
    ...
    "KEY_METRICS": [
        ...
        ("High-NA 订单", "约 20 台"),
        ("光刻机市占", "约 90%"),
        ("最新股价 / 市值", "$1,385 / $5,336 亿"),
        ("PE (TTM)", "约 58×"),
    ],

    "RISKS_HIGHLIGHTS": [
        ("亮点", "High-NA EUV 订单 20 台", "Intel+台积电抢购,2nm 以下光刻唯一选择"),
        ("亮点", "订单积压 $389 亿", "超过 1 年产能,FY26-27 营收可见度高"),
    ...
    "DATA_SOURCE": '经营数据：ASML FY2025 年报/业绩会（2026-01） · 行情数据：CompaniesMarketCap 全球市值排名页，页面查看 2026-04-29（市值/股价为页面展示口径） · 欧元金额按 2026-04-26 近似汇率 1 EUR≈1.08 USD 折算',
    "FOOTER_LINES": [
        '经营数据：ASML FY2025 年报/业绩会（2026-01）',
        '行情数据：CompaniesMarketCap 全球市值排名页，页面查看 2026-04-29（市值/股价为页面展示口径）',
        '汇率口径：欧元金额按 2026-04-26 近似汇率 1 EUR≈1.08 USD 折算',
