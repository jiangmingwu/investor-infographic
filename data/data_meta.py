...
DATA = {
    ...
    "COMPANY_PROFILE": {
        ...
        "最新股价 / 市值": "约 $671 / $1.70 万亿美元 (2026-04-29)",
        "最新 PE (TTM)": "约 27×",
    ...
    "DATA_SOURCE": '经营数据：Meta FY2025 年报/业绩会（2026-01） · 行情数据：CompaniesMarketCap 全球市值排名页，页面查看 2026-04-29（市值/股价为页面展示口径）',
    "FOOTER_LINES": [
        '经营数据：Meta FY2025 年报/业绩会（2026-01）',
