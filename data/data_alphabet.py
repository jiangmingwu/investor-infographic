...
GOOGLE_GREEN = "#34A853"
MARKET_NOTE = "行情市值参考 StockAnalysis / CompaniesMarketCap，2026-04-28 收盘：GOOGL 约 $349.78，市值约 $4.24T"
...
DATA = {
    ...
    "COMPANY_PROFILE": {
        ...
        "最新股价 / 市值": "约 $350 / $4.2 万亿美元 (2026-04-28)",
        "最新 PE (TTM)": "约 42×（按 FY25 净利约 $1,000 亿估算）",
    },
    ...
    "QUOTES": [
        ...
        "— 分析师:谷歌是 AI 时代的全栈玩家,但 $4T+ 市值下估值弹性需重估",
    ],

    "DATA_SOURCE": '经营数据：Alphabet FY2025 年报/业绩公告（2026-02）与业绩会 · 行情数据：CompaniesMarketCap 全球市值排名页，页面查看 2026-04-29（市值/股价为页面展示口径）',
    "FOOTER_LINES": [
        '经营数据：Alphabet FY2025 年报/业绩公告（2026-02）与业绩会',
